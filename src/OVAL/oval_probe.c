...
oval_probe_meta_t OSCAP_GSYM(__probe_meta)[] = {
		...
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_REGISTRY,"registry"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_WMI,"wmi"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_WMI_57,"wmi57"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_LOCKOUT_POLICY, "lockoutpolicy"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_ACCESS_TOKEN,"accesstoken"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_PASSWORD_POLICY,"passwordpolicy"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_USER,"user"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_SID,"sid"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_AUDIT_EVENT_POLICY,"auditeventpolicy"),
		OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_AUDIT_EVENT_POLICY_SUBCATEGORIES,"auditeventpolicysubcategories"),
        OVAL_PROBE_EXTERNAL(OVAL_WINDOWS_FILE, "winfile"),
};
